...
import com.micheal.rxgallery.utils.ModelUtils;
import com.micheal.rxgallery.utils.StorageUtils;
...
//    }
    ...
    public RxGalleryFinal selected(@NonNull List<MediaEntity> list) {
    ...
    public RxGalleryFinal cropAllowedGestures(@UCropActivity.GestureTypes int tabScale,
        ...
        configuration.setGestures(new int[]{tabScale, tabRotate, tabAspectRatio});
        return this;
    }
